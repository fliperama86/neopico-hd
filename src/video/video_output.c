...
void video_output_init(uint16_t *framebuffer, uint frame_width,
                       uint frame_height) {
...
void video_output_start(void) { multicore_launch_core1(core1_main); }

struct dvi_inst *video_output_get_dvi(void) { return &dvi0; }
